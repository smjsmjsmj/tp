...
<!--[if IE 6]>
<script type="text/javascript" src="/tp/Public/cookeryManageSystem/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="page-container">
	<p class="f-20 text-success">欢迎 <?php echo ($userName); ?>用户</p>
</div>
