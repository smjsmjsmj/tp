...
<article class="page-container">
	<form action="/" method="post" class="form form-horizontal" id="form-change-password">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"><?php echo ($userName); ?></div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input class="btn btn-primary radius" type="button" onclick="updatePwd()" value="&nbsp;&nbsp;保存&nbsp;&nbsp;">
			</div>
		</div>
	</form>
</article>
...
function updatePwd()
{
	$.ajax({
		type:"post",
		url:"/tp/CookeryManageSystem/users/updatePwd",
		async:true,
		data:{"pwd":$("#newpassword").val(),"ID":$("#ID").val()},
